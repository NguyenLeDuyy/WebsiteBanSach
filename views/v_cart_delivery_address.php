        ...
        <div class="left-delivery">
            <form class="delivery-form" action="?ctrl=cart&view=payment" method="POST">
                ...
                <div class="form-group">
                    ...
                    <br>
                    <input class="form-control" type="text" id="fullname" name="fullname" required value="<?= $_SESSION['user']['fullname'] ?>">
                </div>
                ...
                <div class="form-group" id="address-box">
                    ...
                    <br>
                    <input class="form-control" type="email" id="email" name="email" required value="<?= $_SESSION['user']['email'] ?>">
                </div>
